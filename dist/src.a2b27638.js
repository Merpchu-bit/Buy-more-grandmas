...
var displayCookies = document.querySelector("#total-cookies");
var displayOvens = document.querySelector("#total-ovens");
...
oven.onclick = function () {
  if (totalCookies < 50) {
    alert("You neeed 30 cookies to buy an oven.");
  } else {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33827" + '/');
